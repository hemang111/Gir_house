...
const Marquee1 = () => {
  return (
    ...
    <Marquee className='absolute flex h-full justify-start overflow-hidden font-semibold text-yellow-400 font-zentry  items-center text-9xl bg-red-400 origin-center' style={{border: '2px solid black', rotate: '9deg' , width:'150vw' }} direction='right'  speed={200}>
